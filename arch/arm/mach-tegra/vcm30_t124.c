...
static __initdata struct tegra_clk_init_table vcm30_t124_clk_init_table[] = {
	...
	{ "pll_p_out4",		"pll_p",	144000000,	true},
	{ "pll_p_out5",		"pll_p",	144000000,	true},

	{ "mselect",		"pll_p",	144000000,	true},
	{ "automotive.mselect",	NULL,		144000000,	true},
	...
	{ "sata_oob",		"pll_p",	144000000,	false},
	{ "sata",		"pll_p",	144000000,	false},
...
static  __initdata struct tegra_clk_init_table
	...
	SET_FIXED_TARGET_RATE("sata_oob",	144000000),
	SET_FIXED_TARGET_RATE("sata",		144000000),
	...
	SET_FIXED_TARGET_RATE("mselect",	144000000),
