...
static const char lg_1080p_edid[256] = {
	,
	...
	0x18,0x71,0x38,0x2d,0x40,0x58,0x2c,0x45,0x00,0xdd,0x0c,0x11,0x00,0x00,0x1e,0x01,
	0x1d,0x80,0x18,0x71,0x1c,0x16,0x20,0x58,0x2c,0x25,0x00,0xdd,0x0c,0x11,0x00,0x00,
	0x9e,0x01,0x1d,0x00,0x72,0x51,0xd0,0x1e,0x20,0x6e,0x28,0x55,0x00,0xdd,0x0c,0x11,
	0x00,0x00,0x1e,0x8c,0x0a,0xd0,0x8a,0x20,0xe0,0x2d,0x10,0x10,0x3e,0x96,0x00,0xdd,
	0x0c,0x11,0x00,0x00,0x18,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
...
int tegra_edid_get_monspecs(struct tegra_edid *edid, struct fb_monspecs *specs)
{
	...
	if (edid->dc->vedid) {
		...
		memcpy(data, lg_1080p_edid /*default_720p_edid*/, 128);
	...
	for (i = 1; i <= extension_blocks; i++) {
		if (edid->dc->vedid) {
			...
			memcpy(data + i * 128,
				lg_1080p_edid /*default_720p_edid*/ + i * 128, 128);
		} else {
